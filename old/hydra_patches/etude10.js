...
shape(4, 0.3, 0)
     //.modulatePixelate(osc(()=>freq))
      .modulateScrollY(osc(()=>rate*0.1))
      .modulateRepeatY(osc(()=>1/rate), 2, 8)
      //.scale([0.1, 0.2, 0.04])
      .out(o0)
//////
render(o0)
...
shape(2, 0.1, 0)
    //.modulatePixelate(osc(()=>freq))
      .repeatY(10)
      .scrollY(0.01, ()=>yrep*0.005)
      .modulateScrollY(osc(()=>oscrate*0.61))
...
render(o1)
    ...
    shape(4,0.7,0)
      //.mult(osc(0.1,9,0))
        .modulateRepeatX(osc(2000,(()=>yrep)), ({time}) => Math.sin((time)) * 100, 100)
      //.blend(o1, ({time}) => Math.square((time)))
      .blend(o2)
        .invert(()=>inv)
        //.modulateRepeatX(shape(100, 0.2, 0))
        .modulateRepeatY(osc(()=>grip*0.005), 1, 1)
        .out(o2)
        //render(o2)
